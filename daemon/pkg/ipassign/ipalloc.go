...
// NewSubnet6Allocator creates an allocator for IPv6 ranges from a given base IPv6 network.
//
// It returns an error if the base network is nil, an invalid IPv6 range or if the prefix is outside the
// (0, 128] range.
...
// NewIPv6Allocator creates an allocator for IPv6 addresses from a given base network.
//
// It returns an error if the base network is nil, or an invalid IPv6 range.
