...
*/}}
{{- define "loom-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "loom-operator.resourceName" -}}
{{- $fullname := include "loom-operator.fullname" .context }}
{{- $suffix := .suffix }}
