...
func (est *EndpointSliceTracker) StaleSlices(ns *corev1alpha1.NetworkService, endpointSlices []*discovery.EndpointSlice) bool {
	est.lock.Lock()
	defer est.lock.Unlock()

	nn := types.NamespacedName{Name: ns.Name, Namespace: ns.Namespace}
