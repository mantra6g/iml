...
const (
	...
	EventLocalSimpleVnfGroupCreated      = "vnfs:group:local:simple:created"
	EventLocalVnfMultiplexedGroupCreated = "vnfs:group:local:multiplexed:created"
	EventLocalSimpleVnfGroupRemoved      = "vnfs:group:local:simple:removed"
	EventLocalVnfMultiplexedGroupRemoved = "vnfs:group:local:multiplexed:removed"
