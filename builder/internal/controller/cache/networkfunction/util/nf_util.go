...
func IsRollingUpdate(nf *cachev1alpha1.NetworkFunction) bool {
	return nf.Spec.Strategy == nil || nf.Spec.Strategy.Type == cachev1alpha1.DeploymentStrategyTypeRollingUpdate
}

func MaxUnavailable(nf *cachev1alpha1.NetworkFunction) int32 {
...
func MinAvailable(nf *cachev1alpha1.NetworkFunction) int32 {
...
func MaxSurge(nf *cachev1alpha1.NetworkFunction) int32 {
	if !IsRollingUpdate(nf) {
		return 0
	}
...
func NewNfCondition(condType cachev1alpha1.NFConditionType, status metav1.ConditionStatus,
	reason, message string) *cachev1alpha1.NFCondition {
	return &cachev1alpha1.NFCondition{
		Type:               condType,
		Status:             status,
		Reason:             reason,
		Message:            message,
...
func GetNfCondition(status *cachev1alpha1.NetworkFunctionStatus,
	condType cachev1alpha1.NFConditionType) *cachev1alpha1.NFCondition {
...
func SetNfCondition(status *cachev1alpha1.NetworkFunctionStatus, condition cachev1alpha1.NFCondition) {
...
func RemoveNfCondition(status *cachev1alpha1.NetworkFunctionStatus, condType cachev1alpha1.NFConditionType) {
	status.Conditions = filterConditions(status.Conditions, condType)
}

func filterConditions(
	conditions []cachev1alpha1.NFCondition, condType cachev1alpha1.NFConditionType,
) []cachev1alpha1.NFCondition {
	newConditions := make([]cachev1alpha1.NFCondition, 0)
...
func ComputeSpecHash(nf *cachev1alpha1.NetworkFunction) string {
	hasher := fnv.New32a()
...
func EqualIgnoreHash(t1 *schedulingv1alpha1.NetworkFunctionBindingTemplate,
	...
	delete(t1Copy.Labels, cachev1alpha1.NF_BINDING_SPEC_HASH_LABEL)
	delete(t2Copy.Labels, cachev1alpha1.NF_BINDING_SPEC_HASH_LABEL)
...
func NeedsScaling(
	ctx context.Context, nf *cachev1alpha1.NetworkFunction,
...
func SetNewReplicaSetAnnotations(ctx context.Context, nf *cachev1alpha1.NetworkFunction,
...
func SetNFRevision(nf *cachev1alpha1.NetworkFunction, revision string) bool {
	updated := false
...
func NFDeploymentComplete(nf *cachev1alpha1.NetworkFunction) bool {
...
func NewRSNewReplicas(nf *cachev1alpha1.NetworkFunction,
